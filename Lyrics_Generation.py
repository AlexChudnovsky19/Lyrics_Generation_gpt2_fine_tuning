...
model = GPT2LMHeadModel.from_pretrained(r'C:\Users\alexc\Fine_tuning_gpt2\best')
tokenizer = GPT2TokenizerFast.from_pretrained(r'C:\Users\alexc\Fine_tuning_gpt2\tokenizer')
