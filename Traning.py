...
if os.path.exists(r'C:\Users\alexc\Fine_tuning_gpt2\final_cleaned_lyrics.txt'):
    file_path = r'C:\Users\alexc\Fine_tuning_gpt2\final_cleaned_lyrics.txt'
else:
...
base_dir = r'C:\Users\alexc\Fine_tuning_gpt2'

# Create the directory if it does not exist
if not os.path.exists(base_dir):
    os.makedirs(base_dir)

# Paths for model, tokenizer, and training arguments
model_dir = os.path.join(base_dir, 'model')
tokenizer_dir = os.path.join(base_dir, 'tokenizer')
args_file = os.path.join(base_dir, 'training_args.json')
